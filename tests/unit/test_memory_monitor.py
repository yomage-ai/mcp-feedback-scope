...
from mcp_feedback_scope.utils.memory_monitor import (
    MemoryAlert,
    MemoryMonitor,
    MemorySnapshot,
    get_memory_monitor,
...
class TestMemoryMonitor:
    ...
    @patch("mcp_feedback_scope.utils.memory_monitor.psutil")
    ...
    @patch("mcp_feedback_scope.utils.memory_monitor.gc")
